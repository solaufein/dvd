            ...
            <c:when test="${client.id =='-1'}">
                ...
                <form:form method="POST" commandName="client" action="addclient">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><form:label path="city"><spring:message
                                    code="clients.clientsList.city"/>:</form:label></td>
                            <td><form:input path="city" cssClass="inputs"></form:input></td>
                            <td><form:errors path="city" cssClass="error"></form:errors></td>
                        </tr>
                        <tr>
                            <td><form:label path="street"><spring:message
                                    code="clients.clientsList.street"/>:</form:label></td>
                        ...
                        <tr>
                            <td><form:label path="email"><spring:message
                                    code="clients.clientsList.email"/>:</form:label></td>
