...
<tiles:insertDefinition name="defaultTemplate">
	...
	<h2>
		...
		<div class="inputs">
			<ul>
				<li><label> <spring:message code="movies.moviesList.title"/>: </label> <c:out value="${movie.title}"/>  </li>
				<li><label> <spring:message code="movies.moviesList.director"/>: </label>  <c:out value="${movie.director}"/>  </li>
				<li><label> <spring:message code="movies.moviesList.productionYear"/>: </label>  <c:out value="${movie.productionYear}"/>  </li>
				<li><label> <spring:message code="movies.moviesList.genre"/>: </label>  <c:out value="${movie.genre}"/>  </li>
				<li><label> <spring:message code="movies.moviesList.promotion"/>: </label>  <c:out value="${movie.promotion}"/>  </li>
			</ul>
		</div>
		</div>
